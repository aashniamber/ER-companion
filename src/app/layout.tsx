    ...
    <html lang="en">
      <body className={`${fraunces.className} bg-cream`}>
        <div className="min-h-screen flex flex-col">
          {/* Header */}
          <header className="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-700 text-white sticky top-0 z-50 shadow-lg">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    A patient education platform designed to reduce ER anxiety
                    by helping patients understand the emergency department
                    process.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ER Companion is for education only. It does not replace
                    medical advice from healthcare professionals. Always follow
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    We collect no personal health information. All data is
